...
curve_difference_test <- function(df, time.var=NULL, 
                             species.var, 
                             abundance.var, 
                             replicate.var, 
                             treatment.var=NULL, 
...
# NOTE: when ranks are assigned by treatment and not replicate, treatment is fed into replicate.var
 relrank_test <- function(df, species.var, abundance.var, replicate.var) {
...
curve_diff_test <- function(df, treatment.var, relrank, cumabund) {
